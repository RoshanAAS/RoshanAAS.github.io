...
import resume from "../images/Roshan-Routh-Resume.pdf"
      ...
      <Flex justifyContent={"space-evenly"} w="100%">
        <Box>
          ...
          >
            ...
            >
              <Typical
                steps={["Hello", 1000, "My name is Roshan Kr Routh", 2000]}
                loop={Infinity}
                wrapper="p"
              />
            </Heading>
            ...
            >
              ...
              <Tooltip hasArrow label="LinkedIn" bg="gray.300" color="black">
                ...
                >
                  <NavLink
                    to={
                      "https://www.linkedin.com/in/roshan-kr-routh/"
                    }
                    target={"_blank"}
                  >
                  ...
                  <Box
                    ...
                    onClick={() => {
                      window.location.href =
                        "mailto:roshan555routh@gmail.com";
                    }}
                  >
                    <TfiEmail size="50px" />
                  </Box>
        ...
        <a
          ...
          onClick={() => {
            window.open(
              "https://drive.google.com/file/d/1UjKS03xGhX1OJlYRRp_Bdr96ajbnt77S/view?usp=sharing"
            );
          }}
        >
          <Button
